...
public class PreceptorForm implements Serializable {
    ...
    @NotBlank
    private String npOverYear; //Have you been a Nurse Practitioner for over a year? (yes or no)
    
    @NotBlank
    private String locationType; //Private, hospital or other (three options)
	...
	public String getNpOverYear() {
		return npOverYear;
	}

	public void setNpOverYear(String npOverYear) {
		this.npOverYear = npOverYear;
	}
